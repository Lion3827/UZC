...
def filter_chat_message(msg: str, client_id: int) -> str | None:
    ...
    try:
        ...
        if entry:
            ...
            _chatlog.push(aid, name, msg)
    except Exception:
        pass
    try:
        from plugins.live_chat import live_chat as _live_chat
        _live_chat.on_chat(msg, client_id)
    except Exception as e:
        import traceback; traceback.print_exc()
        print(f'[live_chat] hook error: {e}')
    try:
        from plugins.cmds import cmds as _cmds
        return _cmds._filter_chat_hook(msg, client_id)
    except Exception as e:
        print(f'[cmds] hook error: {e}')
    return msg
